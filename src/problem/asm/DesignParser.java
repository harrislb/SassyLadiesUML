...
public class DesignParser {
	...
	public static void main(String[] args) throws IOException{
		...
		for(String className: classes){
			...
			ClassVisitor fieldVisitor = new ClassFieldVisitor(Opcodes.ASM5, decVisitor, myClass);
			
			
			// DECORATE field visitor with method visitor
			ClassVisitor methodVisitor = new ClassMethodVisitor(Opcodes.ASM5, fieldVisitor, myClass);
